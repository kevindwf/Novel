...
namespace Novel.Data
{
    public abstract class DbHelper
    {
        ...
        public static int ExecuteInsertScalar(CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
            DbCommand cmd = Provider.CreateCommand();
        ...
        public static int ExecuteInsertScalar(DbConnection connection, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
